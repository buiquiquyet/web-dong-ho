    ...
    <div class="header_are1">
        ...
        <header class="header_section">
            <div class="header_nav">
                ...
                <div class="header_option" style="justify-content:end">
                    ...
                    <div class="header_selection">
                        <div class="header_selection--a">
                            ...
                            <a href="cart.php" class="header_a">
                                ...
                                <div class="header_selection--info"><span>Giỏ hàng </span> <span class="selection_info--span" id="selection_info--span"><?php echo $giohang['count(maSp)'] ?> sản phẩm</span>  </div>
                            </a>
                        </div>
                        <div class="header_selection--a">
                ...
                <div class="header_menu">
                    ...
                    <ul class="header_list">
                        <li class="header_list-items">
                            <a href="index.php"  class="items_link">HOME</a>
                        </li>
                        <li class="header_list-items">
                            <a href="index.php#watch1" class="items_link">WATCHES</a>
                        </li>
                        <li class="header_list-items">
                            <a href="index.php#about1" class="items_link">ABOUT</a>
                        </li>
                        <li class="header_list-items">
                            <a href="index.php#contact1" class="items_link">CONTACT US</a>
                        </li>
                    </ul>
                </div>
            </div>
