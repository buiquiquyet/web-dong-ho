		...
		<div class="right_col" role="main" >
          <div class="">
			...
			<?php
				...
				$lietke_sql = "SELECT * FROM khachhang order by taiKhoanKh desc limit $begin,5   ";
				//thuc thi cau lenh
			...
			<tr>
					<th><?php echo  $r['taiKhoanKh'] ?></th>
					<th><?php echo  $r['matKhau']?></th>
			 ...
			 require_once 'condb1.php';
				...
				$phantrang = "SELECT * FROM khachhang ";
			  ...
			  <nav aria-label="Page navigation example">
					  ...
					  <ul class="pagination">
					   ...
					   <?php
						...
						for($i=1; $i <=$trang; $i++)
						{?>
							<li class="page-item"><a class="page-link" href="user.php?trang=<?php echo $i ?>"><?php echo $i ?></a></li>
						<?php
						}
			  ?>
